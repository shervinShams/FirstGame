...
public class PostmanMovment : MonoBehaviour
{
    ...
    private float groundRadius = 10.0f;
...

    {
        ...
        if (Input.GetAxis("PostmanJump") > 0 && isGrounded)
    ...
    void FixedUpdate()
    {
        ...
        float moveHoriz = Input.GetAxis("Postman");
