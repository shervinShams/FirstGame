...
public class BlacGuyMovment : MonoBehaviour {
    ...
    private float groundRadius = 4.0f;
...

    {
        ...
        if (Input.GetAxis("BlackGuyJump") > 0 && isGrounded)
    ...
    void FixedUpdate()
    {
        ...
        float moveHoriz = Input.GetAxis("BlackGuy");
